...
class NodeCommon implements Node {
  object: ModelObject
  type: string
  key: Key
  nodes: List<Node>
...
Object.getOwnPropertyNames(NodeCommon.prototype).forEach(method => {
  if (method == 'constructor') return
  Block.prototype[method] = NodeCommon.prototype[method]
  Inline.prototype[method] = NodeCommon.prototype[method]
  Document.prototype[method] = NodeCommon.prototype[method]
})

Block.createChildren = NodeFactory.createList
Inline.createChildren = NodeFactory.createList
Document.createChildren = NodeFactory.createList
